...
Binning data by 1 ˚
```{r}
etopo_shelf_dt_north_binned <- etopo_shelf_dt_north[,sum(habitat) , .(gr=cut(y,breaks=seq(0,90,by = (1))))]
...
west_pac_shelf_areas[, change_above_2fold := ifelse(percent_change>=2, 1, ifelse(percent_change<=-0.5, -1, 0))]
...
east_pac_shelf_areas[, change_above_2fold := ifelse(percent_change>=2, 1, ifelse(percent_change<=-0.5, -1, 0))]
...
west_atl_shelf_areas[, change_above_2fold := ifelse(percent_change>=2, 1, ifelse(percent_change<=-0.5, -1, 0))]
...
east_atl_shelf_areas[, change_above_2fold := ifelse(percent_change>=2, 1, ifelse(percent_change<=-0.5, -1, 0))]
...
west_ind_shelf_areas[, change_above_2fold := ifelse(percent_change>=2, 1, ifelse(percent_change<=-0.5, -1, 0))]
...
east_ind_shelf_areas[, change_above_2fold := ifelse(percent_change>=2, 1, ifelse(percent_change<=-0.5, -1, 0))]
