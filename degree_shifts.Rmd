...
area_latitude_west_pac <- ggplot(west_pac_shelf_areas, aes(latitude_start, area)) +
  geom_point(shape =18) + 
  geom_line() +
  labs(x = "Latitude", y = bquote("Area" (km^2))) +
