...
stats_string<-grep("stats",names(.GlobalEnv),value=TRUE)
...
ggplot(data = significant_changes.long, aes(x="", y = value, fill = change_type)) +
  ...
  scale_fill_manual(values = c("darksalmon", "azure2", "cyan3")) +
  facet_wrap(~region) +
  geom_text(aes(y = value-(value/3), 
...
ggsave(plot = west_pacific_merge_map_plot, filename = "west_pacific_merge_map_plot.pdf", width = 7, height = 3, units = "in")
