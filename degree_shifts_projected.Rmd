...
save(west_pac_shelf_areas, "west_pac_shelf_areas.RData")
...
#all chunks for west pacific
east_pac_north_latitudes <- seq(0, ymax(east_pac_spdf_shift_mask_1s), by = 1)
east_pac_south_latitudes <- seq(0, ymin(east_pac_spdf_shift_mask_1s), by = -1)
