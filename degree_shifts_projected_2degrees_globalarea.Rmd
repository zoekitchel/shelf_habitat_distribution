...
shelf_areas[, final_area_reg := original_area_reg + sum(area_change, na.rm = T), region] #final area by region
...
shelf_areas[, change_spp_predicted_levin :=  original_spp_predicted_levin -  shift(original_spp_predicted_levin, n = 1, type = "lag"), region] #change in species from previous bin to this bin?
...
But, what about Chittaro et al. 2010 (Levin is on this paper as well)
spp = 26.1*A^0.183
```{r}
