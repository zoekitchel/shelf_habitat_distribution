...
west_pac_shelf_areas[, percent_change := (area_rasterarea-shift(area_rasterarea, type = "lag"))/shift(area_rasterarea, type = "lag")][,area_1000s := area_rasterarea/1000]
...
west_pac_north_mod <- lm(data = west_pac_shelf_areas[latitude_end > 0], area_rasterarea ~ latitude_start)
west_pac_north_mod$coefficients[2]
summary(west_pac_north_mod)$coefficients[,"Pr(>|t|)"][2]

west_pac_south_mod <- lm(data = west_pac_shelf_areas[latitude_end < 0], area_rasterarea ~ abs(latitude_start))
...
east_pac_shelf_areas[, percent_change := (area_rasterarea-shift(area_rasterarea, type = "lag"))/shift(area_rasterarea, type = "lag")][,area_1000s := area_rasterarea/1000]
...
east_pac_north_mod <- lm(data = east_pac_shelf_areas[latitude_end > 0], area_rasterarea ~ latitude_start)
summary(east_pac_north_mod)

east_pac_south_mod <- lm(data = east_pac_shelf_areas[latitude_end < 0], area_rasterarea ~ abs(latitude_start))
...
west_atl_shelf_areas[, percent_change := (area_rasterarea-shift(area_rasterarea, type = "lag"))/shift(area_rasterarea, type = "lag")][,area_1000s := area_rasterarea/1000]
...
Model change for southern and northern hemisphere
```{r model northern versus southern western tlantic}
west_atl_north_mod <- lm(data = west_atl_shelf_areas[latitude_end > 0], area_rasterarea ~ latitude_start)
summary(west_atl_north_mod)

west_atl_south_mod <- lm(data = west_atl_shelf_areas[latitude_end < 0], area_rasterarea ~ abs(latitude_start))
...
east_atl_shelf_areas[, percent_change := (area_rasterarea-shift(area_rasterarea, type = "lag"))/shift(area_rasterarea, type = "lag")][,area_1000s := area_rasterarea/1000]
...
east_atl_north_mod <- lm(data = east_atl_shelf_areas[latitude_end > 0], area_rasterarea ~ latitude_start)
summary(east_atl_north_mod)

east_atl_south_mod <- lm(data = east_atl_shelf_areas[latitude_end < 0], area_rasterarea ~ abs(latitude_start))
...
west_ind_shelf_areas[, percent_change := (area_rasterarea-shift(area_rasterarea, type = "lag"))/shift(area_rasterarea, type = "lag")][,area_1000s := area_rasterarea/1000]
...
west_ind_north_mod <- lm(data = west_ind_shelf_areas[latitude_end > 0], area_rasterarea ~ latitude_start)
summary(west_ind_north_mod)

west_ind_south_mod <- lm(data = west_ind_shelf_areas[latitude_end < 0], area_rasterarea ~ abs(latitude_start))
...
east_ind_shelf_areas[, percent_change := (area_rasterarea-shift(area_rasterarea, type = "lag"))/shift(area_rasterarea, type = "lag")][,area_1000s := area_rasterarea/1000]
...
east_ind_north_mod <- lm(data = east_ind_shelf_areas[latitude_end > 0], area_rasterarea ~ latitude_start)
summary(east_ind_north_mod)

east_ind_south_mod <- lm(data = east_ind_shelf_areas[latitude_end < 0], area_rasterarea ~ abs(latitude_start))
...
#similate data to plot trendline
east_ind_north_data <- data.table(latitude_start = unique(east_ind_shelf_areas[latitude_end>0,]$latitude_start))

east_ind_north_data[,area_1000s := east_ind_north_mod$coefficients[[1]]/1000+east_ind_north_mod$coefficients[[2]]/1000*latitude_start]

east_ind_south_data <- data.table(latitude_start = unique(east_ind_shelf_areas[latitude_end <0,]$latitude_start))

east_ind_south_data[,area_1000s := east_ind_south_mod$coefficients[[1]]/1000+east_ind_south_mod$coefficients[[2]]/1000*(-latitude_start)]

#east indian
(area_latitude_east_ind  <- ggplot() +
#  geom_line(data = east_ind_north_data, aes(x=latitude_start, y = area_1000s), color = "gray71") + not significant
#  geom_line(data = east_ind_south_data, aes(x=latitude_start, y = area_1000s), color = "gray71") + not significant
 ...
 labs(x = "Latitude", y = expression(paste("Area (1000s of ", km^{2},")"))) +
  scale_color_viridis_d(option = "A", begin = 0.3, end = 0.7, name = "Instances of 2 Fold\n Habitat Change", labels = c("Contraction", "Expansion")) +
...
west_ind_north_data <- data.table(latitude_start = unique(west_ind_shelf_areas[latitude_end>0,]$latitude_start))

west_ind_north_data[,area_1000s := west_ind_north_mod$coefficients[[1]]/1000+west_ind_north_mod$coefficients[[2]]/1000*latitude_start]

west_ind_south_data <- data.table(latitude_start = unique(west_ind_shelf_areas[latitude_end <0,]$latitude_start))

west_ind_south_data[,area_1000s := west_ind_south_mod$coefficients[[1]]/1000+west_ind_south_mod$coefficients[[2]]/1000*(-latitude_start)]

area_latitude_west_ind  <- ggplot() +
  geom_line(data = west_ind_north_data, aes(x=latitude_start, y = area_1000s), color = "gray71") +
 # geom_line(data = west_ind_south_data, aes(x=latitude_start, y = area_1000s), color = "gray71") + not significant
...
west_atl_north_data <- data.table(latitude_start = unique(west_atl_shelf_areas[latitude_end>0,]$latitude_start))

west_atl_north_data[,area_1000s := west_atl_north_mod$coefficients[[1]]/1000+west_atl_north_mod$coefficients[[2]]/1000*latitude_start]

west_atl_south_data <- data.table(latitude_start = unique(west_atl_shelf_areas[latitude_end <0,]$latitude_start))

west_atl_south_data[,area_1000s := west_atl_south_mod$coefficients[[1]]/1000+west_atl_south_mod$coefficients[[2]]/1000*(-latitude_start)]

area_latitude_west_atl  <- ggplot() +
  geom_line(data = west_atl_north_data, aes(x=latitude_start, y = area_1000s), color = "gray71") +
  geom_line(data = west_atl_south_data, aes(x=latitude_start, y = area_1000s), color = "gray71") +
...
east_atl_north_data <- data.table(latitude_start = unique(east_atl_shelf_areas[latitude_end>0,]$latitude_start))

east_atl_north_data[,area_1000s := east_atl_north_mod$coefficients[[1]]/1000+east_atl_north_mod$coefficients[[2]]/1000*latitude_start]

east_atl_south_data <- data.table(latitude_start = unique(east_atl_shelf_areas[latitude_end <0,]$latitude_start))

east_atl_south_data[,area_1000s := east_atl_south_mod$coefficients[[1]]/1000+east_atl_south_mod$coefficients[[2]]/1000*(-latitude_start)]  

area_latitude_east_atl  <- ggplot() +
  geom_line(data = east_atl_north_data, aes(x=latitude_start, y = area_1000s), color = "gray71") +
  geom_line(data = east_atl_south_data, aes(x=latitude_start, y = area_1000s), color = "gray71") +
...
east_pac_north_data <- data.table(latitude_start = unique(east_pac_shelf_areas[latitude_end>0,]$latitude_start))

east_pac_north_data[,area_1000s := east_pac_north_mod$coefficients[[1]]/1000+east_pac_north_mod$coefficients[[2]]/1000*latitude_start]

east_pac_south_data <- data.table(latitude_start = unique(east_pac_shelf_areas[latitude_end <0,]$latitude_start))

east_pac_south_data[,area_1000s := east_pac_south_mod$coefficients[[1]]/1000+east_pac_south_mod$coefficients[[2]]/1000*(-latitude_start)]

area_latitude_east_pac  <- ggplot() +
  geom_line(data = east_pac_north_data, aes(x=latitude_start, y = area_1000s), color = "gray71") +
#  geom_line(data = east_pac_south_data, aes(x=latitude_start, y = area_1000s), color = "gray71") + not significant
...
west_pac_north_data <- data.table(latitude_start = unique(west_pac_shelf_areas[latitude_end>0,]$latitude_start))

west_pac_north_data[,area_1000s := west_pac_north_mod$coefficients[[1]]/1000+west_pac_north_mod$coefficients[[2]]/1000*latitude_start]

west_pac_south_data <- data.table(latitude_start = unique(west_pac_shelf_areas[latitude_end <0,]$latitude_start))

west_pac_south_data[,area_1000s := west_pac_south_mod$coefficients[[1]]/1000+west_pac_south_mod$coefficients[[2]]/1000*(-latitude_start)]

(area_latitude_west_pac <- ggplot() +
  geom_line(data = west_pac_north_data, aes(x=latitude_start, y = area_1000s), color = "gray71") +
  geom_line(data = west_pac_south_data, aes(x=latitude_start, y = area_1000s), color = "gray71") +
...
ggplot(data = significant_changes.long, aes(x="", y = percent_by_hemisphere, fill = type)) +
  ...
  scale_fill_manual(values = c(viridis_exp_cont[1], "grey94", viridis_exp_cont[2]), name = "Habitat Change", labels = c(">= 2 Fold Contraction", "< 2 Fold Change", ">= 2 Fold Expansion")) +
  facet_grid(hemisphere~region_names) +
 # geom_text(aes(label = paste0(percent_by_hemisphere,"%")), position = position_stack(vjust = 0.1), size = 1.5) +
  scale_x_discrete(expand = c(0,0)) +
  blank_theme +
  theme(axis.text.x=element_blank(),
        strip.text = element_text(size = 7))

ggsave(filename = "figure6_habitatloss_gain_2fold_byhemisphere.pdf", height = 2, width = 6, unit = "in")
...
ggsave(filename = "figure6_habitatloss_gain_2fold_byregion.pdf", height = 4, width = 8, unit = "in")
...
#NEED TO CHECK STATS IN THIS TABLE
...
Visualize regional statistics (same as above, another possibility for figure 6 but spliting northern and southern hemispheres)
```{r visualize regional stats}
#pull back to long form
regional_statistics_long <- melt(regional_statistics, id.vars = c("region","hemisphere"),
                measure.vars = c("contractions", "expansions", "coef","pvalue"))

ggplot(data = regional_statistics_long[variable %in% c("contractions","expansions")], aes(x="", y = value, fill = variable)) +
  geom_bar(stat = "identity", width = 1) +
  coord_polar("y", start=0) +
  scale_fill_manual(values = c(viridis_exp_cont[1], "grey94", viridis_exp_cont[2]), name = "Habitat Change", labels = c(">= 2 Fold Contraction", "< 2 Fold Change", ">= 2 Fold Expansion")) +
  facet_wrap(~region) +
...
ggsave(filename = "figure6_habitatloss_gain_2fold.pdf", height = 4, width = 8, unit = "in")
```
