...
saveRDS(east_ind_shelf_areas, file = "east_ind_shelf_areas_2degrees.rds")
...
```{r}
area_lat_mods <- save(west_pac_north_mod, east_pac_north_mod, west_atl_north_mod, west_ind_north_mod, east_atl_north_mod, east_ind_north_mod, west_pac_south_mod, east_pac_south_mod, west_atl_south_mod, west_ind_south_mod, east_atl_south_mod, east_ind_south_mod, file = here::here("table_outputs","area_lat_mods.RData"))
```
