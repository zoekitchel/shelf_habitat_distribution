...
LME_bathy_bydepth_complete_15mbins <- data.table(depth_15s = numeric(), area_summed_15mbins = numeric(),
    ...
    original_spp_predicted_levin = numeric(),original_spp_predicted_175 = numeric(),original_spp_predicted_38 = numeric(), original_spp_predicted_62 = numeric(),
    change_area = numeric(),
    change_spp_predicted_levin = numeric(), change_spp_predicted_175 = numeric(), change_spp_predicted_38 = numeric(), change_spp_predicted_62 = numeric(),
    spp_change_pos_neg_levin = factor(),spp_change_pos_neg_175 = factor(),spp_change_pos_neg_38 = factor(),spp_change_pos_neg_62 = factor(),
    lme_number = numeric(),
    lme_name = numeric())
...
#    geom_hline(yintercept = 0) +
  ...
  lme_spp_count_area_change_3levels[[i]] <- ggplot(data = LME_bathy_bydepth_complete_15mbins_single, aes(x = depth_15s)) +
    geom_col(aes(y = log_abs_change_spp_predicted_38*spp_change_pos_neg_38, fill=spp_change_pos_neg_38_discrete), alpha = 0.5) +
      geom_errorbar(aes(ymin=log_abs_change_spp_predicted_175*spp_change_pos_neg_175, ymax=log_abs_change_spp_predicted_62*spp_change_pos_neg_62))  +
    scale_fill_viridis_d(option = "A", begin = 0.3, end = 0.7, name = paste0("LME: ", LME_area_spp_change_stats[i, "lme_number"],"\n", LME_area_spp_change_stats[[i, "lme_name"]],"\n\nRichness Change with\n15m Depth Shift"), breaks = c(1,-1), labels = c("Gain", "Loss")) +
...
saveRDS(lme_spp_count_area_change_3levels, file = here::here("output","compiled plots", "lme_spp_count_area_change_3levels.rds"))
#to pull in
