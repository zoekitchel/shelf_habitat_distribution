...
#percent change for mean

LME_bathy_bydepth_complete_15mbins[, percent_change_richness_mean := (original_spp_predicted_38-data.table::shift(original_spp_predicted_38, type = "lag"))/data.table::shift(original_spp_predicted_38, type = "lag"), .(lme_name)]

#mean?

mean(LME_bathy_bydepth_complete_15mbins$change_spp_predicted_38, na.rm = T)
