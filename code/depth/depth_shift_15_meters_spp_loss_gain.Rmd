...
saveRDS(lme_spp_count_area_sum_plots, file = here::here("output","compiled plots","lme_spp_count_area_sum_plots.rds"))
#to pull in
lme_spp_count_area_sum_plots <- readRDS(file = here::here("output","compiled plots","lme_spp_count_area_sum_plots.rds"))
#plots to pdf
