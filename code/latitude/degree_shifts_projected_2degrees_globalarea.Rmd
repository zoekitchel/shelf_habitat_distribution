...
#This code loads in latitude versus area data tables from annotate HPC and adds in calculations for changes in species richness based on SAR from Levin et al. 2009. It does not output figures, which you can find in Figure3_5 code.
