...
#LMEs
LME_spdf <- readOGR("raw_data/LME66/LMEs66.shp") #spatial points data frame with 
#all 66 LMEs
...
saveRDS(dip.test_polygon, file = here::here("output","raster_shapefile_comparison","higharctic_dip.test_polygon.rds"))
