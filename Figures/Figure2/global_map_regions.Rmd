...
LME_bathy_statistics <- readRDS(here::here("output", "LME_bathy_statistics_42922_full.rds"))
...
(global_LME_classification_map_altskew <- ggplot() + 
  ...
  scale_fill_manual(values = c("#4A9B7D","#3D4F88", "#FAA23D"), labels = c("Shallow Dominant: 30%", "Multimodal: 69%", "Mid Dominant: 1%")) +
       # add projected countries
    geom_polygon(data = Country.DT, 
                 aes(x = long, y = lat, group = group), 
                 colour = "gray70", 
