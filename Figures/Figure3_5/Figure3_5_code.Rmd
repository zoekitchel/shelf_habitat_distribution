...
load("~/Documents/grad school/Rutgers/Repositories/shelf_habitat_distribution/west_pac_shelf_areas_2degrees.Rdata")
load("~/Documents/grad school/Rutgers/Repositories/shelf_habitat_distribution/west_atl_shelf_areas_2degrees.Rdata")
load("~/Documents/grad school/Rutgers/Repositories/shelf_habitat_distribution/west_ind_shelf_areas_2degrees.Rdata")
load("~/Documents/grad school/Rutgers/Repositories/shelf_habitat_distribution/east_pac_shelf_areas_2degrees.Rdata")
load("~/Documents/grad school/Rutgers/Repositories/shelf_habitat_distribution/east_atl_shelf_areas_2degrees.Rdata")
load("~/Documents/grad school/Rutgers/Repositories/shelf_habitat_distribution/east_ind_shelf_areas_2degrees.Rdata")

load("~/Documents/grad school/Rutgers/Repositories/shelf_habitat_distribution/latitude_area_plots.RData")
...
figure_4_atlantic_full <- egg::ggarrange(region_maps[[3]] + 
 ...
 ylim(y=c(min(west_atl_shelf_areas$latitude_start),max(west_atl_shelf_areas$latitude_start))) +
...
#pacific merge
```{r pacific merge}
figure_3_pacific_full <- egg::ggarrange(region_maps[[1]] + 
                                                theme(legend.position = "top",
                                                      legend.title = element_blank(),
                                                      axis.title.x = element_blank(),
                                                      plot.margin = unit(c(0.1,0.1,0.1,0.1),"cm")) +
 ylim(y=c(min(west_pac_shelf_areas$latitude_start),max(west_pac_shelf_areas$latitude_start))) +
                                                scale_y_continuous(breaks = c(-40,-20,0,20,40,60,80)),
   ...
   xlim(x=c(min(west_pac_shelf_areas$latitude_start),max(west_pac_shelf_areas$latitude_start))) +
                                                scale_x_continuous(breaks = c(-60,-40,-20,0,20,40,60,80)),
 region_maps[[2]] + theme(legend.position = "none",
                                                                          plot.margin = unit(c(0.1,0.1,0.1,0.1),"cm")) +
                                                scale_y_continuous(breaks = c(-60,-40,-20,0,20,40,60,80)),
...
(east_indian_spprichness <- ggplot(data = shelf_areas[region == "East Indian"], aes(x=latitude_start, y=change_spp_predicted_levin)) +
 ...
 labs(x=paste0("Latitude ","\u00B0","N"), y = expression(Delta~'Species Richness')) +
  ...
  xlim(min(east_ind_map$data[[2]]$y), max(east_ind_map$data[[2]]$y)) +
  theme_classic())
...
#  scale_y_continuous(expand = c(0, 0)) +
  geom_vline(xintercept = 0) +
  xlim(x=c(min(shelf_areas[region == "West Indian"]$latitude_start),max(shelf_areas[region == "West Indian"]$latitude_start))) +
...
figure_5_indian_full <- egg::ggarrange(region_maps[[4]] + 
                                                theme(legend.position = "top",
                                                      axis.title.x = element_blank(),
                                                      plot.margin = unit(c(0.1,0.1,0.1,0.1),"cm"))+
   ylim(min(west_ind_map$data[[2]]$y), max(west_ind_map$data[[2]]$y)) +
 ...
 region_maps[[6]] + theme(legend.position = "none",
                          plot.margin = unit(c(0.1,0.1,0.1,0.1),"cm")) +
                                                scale_y_continuous(breaks = c(-60,-40,-20,0,20)) +
   ylim(min(east_ind_map$data[[2]]$y), max(east_ind_map$data[[2]]$y)),
          area_latitude_east_ind + 
   xlim(min(east_ind_map$data[[1]]$y), max(east_ind_map$data[[1]]$y)) +
               theme(axis.text.y = element_blank(),
           #          axis.ticks.y = element_blank(),
                     axis.title.y = element_blank(),
                     legend.position = "none",
