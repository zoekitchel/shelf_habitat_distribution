...
load(here::here("output","2_degree_latitude","east_ind_shelf_areas_2degrees.Rdata"))

load(here::here("output", "2_degree_latitude","latitude_area_plots.RData"))
...
figure_5_indian_full <- egg::ggarrange(region_maps[[4]] + 
 ...
 region_maps[[6]] + theme(legend.position = "none",
                          plot.margin = unit(c(0.1,0.1,0.1,0.1),"cm")) +
                                                scale_y_continuous(breaks = c(-40,-20,0,20)) +  coord_equal(ylim = c(-42, 21), xlim = c(74,152)),
